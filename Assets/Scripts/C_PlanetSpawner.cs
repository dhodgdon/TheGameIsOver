...
public class C_PlanetSpawner : MonoBehaviour
{
    ...
    void MovePlanetDown()
    {
        ...
        aPlanet.GetComponent<C_Planet>().isMoving = true;
    }
    ...
    void EnqueuePlanets()
    {
        foreach (GameObject planet in Planets)
        {
            ...
            if (planet.transform.position.y < 0 || (!planet.GetComponent<C_Planet>().isMoving))
            {
                planet.GetComponent<C_Planet>().ResetPosition();
